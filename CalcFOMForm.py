...
class Ui_CalcFOMDialog(object):
    def setupUi(self, CalcFOMDialog):
        ...
        self.BatchComboBox.raise_()
        self.BatchPushButton.raise_()
        self.gridLayoutWidget_3.raise_()
        self.layoutWidget.raise_()
        self.ImportExpPushButton.raise_()
        self.ImportAnaPushButton.raise_()
        self.textBrowser_plate.raise_()
        self.textBrowser_h.raise_()
        self.textBrowser_comp.raise_()
        self.line.raise_()
        self.line_2.raise_()
        self.line_3.raise_()
        self.line_4.raise_()
        self.AnalysisNamesComboBox.raise_()
        self.label_20.raise_()
        self.AnaTreeWidget.raise_()
        self.getplatemapCheckBox.raise_()
        self.CompPlotOrderComboBox.raise_()
        self.label_2.raise_()
        self.label.raise_()
        self.CompPlotTypeComboBox.raise_()
        self.label_4.raise_()
        self.compplotsizeLineEdit.raise_()
        self.label_3.raise_()
        self.fomplotchoiceComboBox.raise_()
        self.usedaqtimeCheckBox.raise_()
        self.label_9.raise_()
        self.aboverangecolLineEdit.raise_()
        self.label_6.raise_()
        self.belowrangecolLineEdit.raise_()
        self.label_8.raise_()
        self.vminmaxLineEdit.raise_()
        self.stdcsvplotchoiceComboBox.raise_()
        self.label_5.raise_()
        self.colormapLineEdit.raise_()
        self.label_10.raise_()
        self.label_13.raise_()
        self.TechTypeRadioButton_0.raise_()
        self.TechTypeRadioButton_1.raise_()
        self.TechTypeRadioButton_2.raise_()
        self.TechTypeRadioButton_3.raise_()
        self.TechTypeRadioButton_4.raise_()
        self.TechTypeRadioButton_5.raise_()
        self.TechTypeRadioButton_6.raise_()
        self.TechTypeRadioButton_7.raise_()
        self.TechTypeRadioButton_8.raise_()
        self.TechTypeRadioButton_9.raise_()
        self.TechTypeRadioButton_10.raise_()
        self.label_7.raise_()
        self.ExpRunUseComboBox.raise_()
        self.label_14.raise_()
        self.RunSelectTreeWidget.raise_()
        self.UserFOMLineEdit.raise_()
        self.line_5.raise_()
        self.label_21.raise_()
        self.FOMProcessNamesComboBox.raise_()
        self.label_22.raise_()
        self.autoplotCheckBox.raise_()
        self.RaiseErrorPushButton.raise_()
        self.OpenInfoPushButton.raise_()
        self.expfilenameLineEdit.raise_()
        self.line_6.raise_()
        self.label_11.raise_()
        self.AnaDescLineEdit.raise_()
