...
class Ui_CalcFOMDialog(object):
    def setupUi(self, CalcFOMDialog):
        ...
        self.verticalLayoutWidget_2 = QtGui.QWidget(CalcFOMDialog)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(530, 350, 131, 101))
        ...
        self.CompPlotTypeComboBox = QtGui.QComboBox(self.verticalLayoutWidget_2)
        self.CompPlotTypeComboBox.setObjectName(_fromUtf8("CompPlotTypeComboBox"))
        self.verticalLayout_3.addWidget(self.CompPlotTypeComboBox)
        self.label_2 = QtGui.QLabel(self.verticalLayoutWidget_2)
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.verticalLayout_3.addWidget(self.label_2)
        self.CompPlotOrderComboBox = QtGui.QComboBox(self.verticalLayoutWidget_2)
        self.CompPlotOrderComboBox.setObjectName(_fromUtf8("CompPlotOrderComboBox"))
        self.verticalLayout_3.addWidget(self.CompPlotOrderComboBox)
        self.verticalLayoutWidget_4 = QtGui.QWidget(CalcFOMDialog)
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(530, 10, 121, 330))
        ...
        self.xplotchoiceComboBox = QtGui.QComboBox(self.verticalLayoutWidget_4)
        self.xplotchoiceComboBox.setObjectName(_fromUtf8("xplotchoiceComboBox"))
        self.verticalLayout_4.addWidget(self.xplotchoiceComboBox)
        self.label_4 = QtGui.QLabel(self.verticalLayoutWidget_4)
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.verticalLayout_4.addWidget(self.label_4)
        self.yplotchoiceComboBox = QtGui.QComboBox(self.verticalLayoutWidget_4)
        self.yplotchoiceComboBox.setObjectName(_fromUtf8("yplotchoiceComboBox"))
        self.verticalLayout_4.addWidget(self.yplotchoiceComboBox)
        self.label_5 = QtGui.QLabel(self.verticalLayoutWidget_4)
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.verticalLayout_4.addWidget(self.label_5)
        self.xycolplotchoiceComboBox = QtGui.QComboBox(self.verticalLayoutWidget_4)
        self.xycolplotchoiceComboBox.setObjectName(_fromUtf8("xycolplotchoiceComboBox"))
        self.verticalLayout_4.addWidget(self.xycolplotchoiceComboBox)
        self.label_6 = QtGui.QLabel(self.verticalLayoutWidget_4)
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.verticalLayout_4.addWidget(self.label_6)
        self.xminmaxLineEdit = QtGui.QLineEdit(self.verticalLayoutWidget_4)
        self.xminmaxLineEdit.setObjectName(_fromUtf8("xminmaxLineEdit"))
        self.verticalLayout_4.addWidget(self.xminmaxLineEdit)
        self.label_8 = QtGui.QLabel(self.verticalLayoutWidget_4)
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.verticalLayout_4.addWidget(self.label_8)
        self.yminmaxLineEdit = QtGui.QLineEdit(self.verticalLayoutWidget_4)
        self.yminmaxLineEdit.setObjectName(_fromUtf8("yminmaxLineEdit"))
        self.verticalLayout_4.addWidget(self.yminmaxLineEdit)
        self.overlayselectCheckBox = QtGui.QCheckBox(self.verticalLayoutWidget_4)
        self.overlayselectCheckBox.setObjectName(_fromUtf8("overlayselectCheckBox"))
        self.verticalLayout_4.addWidget(self.overlayselectCheckBox)
        self.customxylegendPushButton = QtGui.QPushButton(self.verticalLayoutWidget_4)
        self.customxylegendPushButton.setObjectName(_fromUtf8("customxylegendPushButton"))
        self.verticalLayout_4.addWidget(self.customxylegendPushButton)
        ...
        self.ImportExpPushButton.setGeometry(QtCore.QRect(10, 70, 81, 21))
        self.ImportExpPushButton.setObjectName(_fromUtf8("ImportExpPushButton"))
        self.GrabExpPushButton = QtGui.QPushButton(CalcFOMDialog)
        self.GrabExpPushButton.setGeometry(QtCore.QRect(100, 70, 101, 21))
        self.GrabExpPushButton.setObjectName(_fromUtf8("GrabExpPushButton"))
        ...
        self.line_2.setGeometry(QtCore.QRect(510, 0, 20, 521))
        ...
        self.ImportRunPushButton = QtGui.QPushButton(CalcFOMDialog)
        self.ImportRunPushButton.setGeometry(QtCore.QRect(210, 70, 71, 21))
        self.ImportRunPushButton.setObjectName(_fromUtf8("ImportRunPushButton"))
        self.AnalysisNamesComboBox = QtGui.QComboBox(CalcFOMDialog)
        self.AnalysisNamesComboBox.setGeometry(QtCore.QRect(290, 490, 221, 22))
...
"can be performed", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label.setText(QtGui.QApplication.translate("CalcFOMDialog", "Composition plot type:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_3.setText(QtGui.QApplication.translate("CalcFOMDialog", "x-axis", None, QtGui.QApplication.UnicodeUTF8))
        self.xplotchoiceComboBox.setToolTip(QtGui.QApplication.translate("CalcFOMDialog", "Apply all other filteres in this section to only this run", None, QtGui.QApplication.UnicodeUTF8))
        self.label_4.setText(QtGui.QApplication.translate("CalcFOMDialog", "y-axis", None, QtGui.QApplication.UnicodeUTF8))
        self.yplotchoiceComboBox.setToolTip(QtGui.QApplication.translate("CalcFOMDialog", "Apply all other filteres in this section to only this run", None, QtGui.QApplication.UnicodeUTF8))
        self.label_5.setText(QtGui.QApplication.translate("CalcFOMDialog", "color by", None, QtGui.QApplication.UnicodeUTF8))
        self.xycolplotchoiceComboBox.setToolTip(QtGui.QApplication.translate("CalcFOMDialog", "Apply all other filteres in this section to only this run", None, QtGui.QApplication.UnicodeUTF8))
        self.label_6.setText(QtGui.QApplication.translate("CalcFOMDialog", "x min,max", None, QtGui.QApplication.UnicodeUTF8))
        self.xminmaxLineEdit.setToolTip(QtGui.QApplication.translate("CalcFOMDialog", "Comment string to be included in EXP", None, QtGui.QApplication.UnicodeUTF8))
        self.label_8.setText(QtGui.QApplication.translate("CalcFOMDialog", "y min,max", None, QtGui.QApplication.UnicodeUTF8))
        self.yminmaxLineEdit.setToolTip(QtGui.QApplication.translate("CalcFOMDialog", "Comment string to be included in EXP", None, QtGui.QApplication.UnicodeUTF8))
        self.overlayselectCheckBox.setText(QtGui.QApplication.translate("CalcFOMDialog", "overlay", None, QtGui.QApplication.UnicodeUTF8))
        self.customxylegendPushButton.setToolTip(QtGui.QApplication.translate("CalcFOMDialog", "Import a .exp file, which will clear any existing EXP and RUNs and create new RUNs from the EXP", None, QtGui.QApplication.UnicodeUTF8))
        self.customxylegendPushButton.setText(QtGui.QApplication.translate("CalcFOMDialog", "Customize\n"
"legend", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.EditDfltVisPushButton.setText(QtGui.QApplication.translate("CalcFOMDialog", "Edit Dflt Vis", None, QtGui.QApplication.UnicodeUTF8))
...
" Intermediate data will also be saved", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.GrabExpPushButton.setToolTip(QtGui.QApplication.translate("CalcFOMDialog", "Grab the EXP from the \"Create EXP\" window", None, QtGui.QApplication.UnicodeUTF8))
        self.GrabExpPushButton.setText(QtGui.QApplication.translate("CalcFOMDialog", "Grab active EXP", None, QtGui.QApplication.UnicodeUTF8))
        self.ImportRunPushButton.setToolTip(QtGui.QApplication.translate("CalcFOMDialog", "Import a .rcp file, from which an on-the-fly EXP will be made", None, QtGui.QApplication.UnicodeUTF8))
        self.ImportRunPushButton.setText(QtGui.QApplication.translate("CalcFOMDialog", "Import RUN", None, QtGui.QApplication.UnicodeUTF8))
