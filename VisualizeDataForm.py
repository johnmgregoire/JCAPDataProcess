...
class Ui_VisDataDialog(object):
    def setupUi(self, VisDataDialog):
        ...
        self.browser.setGeometry(QtCore.QRect(930, 40, 661, 171))
        ...
        self.xyLineEdit.setGeometry(QtCore.QRect(1170, 10, 111, 20))
        ...
        self.label_3.setGeometry(QtCore.QRect(1330, 0, 46, 31))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.sampleLineEdit = QtGui.QLineEdit(VisDataDialog)
        self.sampleLineEdit.setGeometry(QtCore.QRect(1370, 10, 111, 20))
        ...
        self.label_8.setGeometry(QtCore.QRect(820, 80, 91, 21))
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.label_10 = QtGui.QLabel(VisDataDialog)
        self.label_10.setGeometry(QtCore.QRect(850, 180, 31, 21))
        ...
        self.belowrangecolLineEdit.setGeometry(QtCore.QRect(810, 150, 61, 22))
        ...
        self.colormapLineEdit.setGeometry(QtCore.QRect(880, 180, 51, 21))
        self.colormapLineEdit.setObjectName(_fromUtf8("colormapLineEdit"))
        self.vminmaxLineEdit = QtGui.QLineEdit(VisDataDialog)
        self.vminmaxLineEdit.setGeometry(QtCore.QRect(820, 100, 91, 22))
        ...
        self.label_12.setGeometry(QtCore.QRect(820, 120, 101, 31))
        self.label_12.setObjectName(_fromUtf8("label_12"))
        self.aboverangecolLineEdit = QtGui.QLineEdit(VisDataDialog)
        self.aboverangecolLineEdit.setGeometry(QtCore.QRect(870, 150, 61, 22))
        ...
        self.platescatterLineEdit.setGeometry(QtCore.QRect(740, 180, 41, 22))
        self.platescatterLineEdit.setObjectName(_fromUtf8("platescatterLineEdit"))
        self.label_16 = QtGui.QLabel(VisDataDialog)
        self.label_16.setGeometry(QtCore.QRect(700, 180, 41, 21))
        ...
        self.saveudiPushButton = QtGui.QPushButton(VisDataDialog)
        self.saveudiPushButton.setGeometry(QtCore.QRect(1530, 20, 41, 23))
        self.saveudiPushButton.setObjectName(_fromUtf8("saveudiPushButton"))
        self.addallsamplesPushButton = QtGui.QPushButton(VisDataDialog)
        self.addallsamplesPushButton.setGeometry(QtCore.QRect(1530, 0, 31, 23))
        self.addallsamplesPushButton.setObjectName(_fromUtf8("addallsamplesPushButton"))
        self.defaultplatemapCheckBox = QtGui.QCheckBox(VisDataDialog)
        ...
        self.numcompintervalsSpinBox = QtGui.QSpinBox(VisDataDialog)
        self.numcompintervalsSpinBox.setGeometry(QtCore.QRect(820, 180, 31, 22))
        self.numcompintervalsSpinBox.setButtonSymbols(QtGui.QAbstractSpinBox.NoButtons)
        self.numcompintervalsSpinBox.setMaximum(100)
        self.numcompintervalsSpinBox.setObjectName(_fromUtf8("numcompintervalsSpinBox"))
        self.label_19 = QtGui.QLabel(VisDataDialog)
        self.label_19.setGeometry(QtCore.QRect(780, 180, 41, 21))
    ...
    def retranslateUi(self, VisDataDialog):
        ...
        self.plateTabWidget.setTabText(self.plateTabWidget.indexOf(self.tab), _translate("VisDataDialog", "Tab 1", None))
        self.compTabWidget.setTabText(self.compTabWidget.indexOf(self.tab_2), _translate("VisDataDialog", "Tab 1", None))
        self.FolderPushButton.setText(_translate("VisDataDialog", "Open OnTheFly Dir", None))
        ...
        self.UpdateFolderPushButton.setText(_translate("VisDataDialog", "^  update  ^", None))
        self.OnFlyStoreInterCheckBox.setText(_translate("VisDataDialog", "store interm.\n"
"data", None))
...
"No(s):", None))
        ...
        self.fomplotchoiceComboBox.setToolTip(_translate("VisDataDialog", "Apply all other filteres in this section to only this run", None))
        self.label_6.setText(_translate("VisDataDialog", "Comp. plot type:", None))
        self.CompPlotTypeComboBox.setToolTip(_translate("VisDataDialog", "Apply all other filteres in this section to only this run", None))
        self.label_8.setText(_translate("VisDataDialog", "fom range min,max", None))
        self.label_10.setText(_translate("VisDataDialog", "color\n"
"map", None))
        self.stdcsvplotchoiceComboBox.setToolTip(_translate("VisDataDialog", "Apply all other filteres in this section to only this run", None))
        self.compplotsizeLineEdit.setToolTip(_translate("VisDataDialog", "Comment string to be included in EXP", None))
        self.compplotsizeLineEdit.setText(_translate("VisDataDialog", "patch", None))
        self.belowrangecolLineEdit.setToolTip(_translate("VisDataDialog", "Comment string to be included in EXP", None))
        self.label_9.setText(_translate("VisDataDialog", "standard plot", None))
        self.label_11.setText(_translate("VisDataDialog", "Comp. point size:", None))
        self.colormapLineEdit.setToolTip(_translate("VisDataDialog", "Comment string to be included in EXP", None))
        self.colormapLineEdit.setText(_translate("VisDataDialog", "jet", None))
        self.vminmaxLineEdit.setToolTip(_translate("VisDataDialog", "Comment string to be included in EXP", None))
        self.CompPlotOrderComboBox.setToolTip(_translate("VisDataDialog", "Apply all other filteres in this section to only this run", None))
        self.label_12.setText(_translate("VisDataDialog", "out of range colors\n"
"   < min       > max", None))
        self.aboverangecolLineEdit.setToolTip(_translate("VisDataDialog", "Comment string to be included in EXP", None))
        self.rightyplotchoiceComboBox.setToolTip(_translate("VisDataDialog", "Apply all other filteres in this section to only this run", None))
        self.label_13.setText(_translate("VisDataDialog", "right y-axis", None))
        self.yplotchoiceComboBox.setToolTip(_translate("VisDataDialog", "Apply all other filteres in this section to only this run", None))
        self.label_14.setText(_translate("VisDataDialog", "y-axis", None))
        self.xplotchoiceComboBox.setToolTip(_translate("VisDataDialog", "Apply all other filteres in this section to only this run", None))
        self.label_15.setText(_translate("VisDataDialog", "x-axis", None))
        self.customxylegendPushButton.setText(_translate("VisDataDialog", "customize\n"
"x-y legend", None))
        self.overlayselectCheckBox.setText(_translate("VisDataDialog", "x-y overlay", None))
        self.FilenameFilterPushButton.setText(_translate("VisDataDialog", "Create file filter\n"
"(for OnTheFly)", None))
        self.UpdateFiltersPushButton.setText(_translate("VisDataDialog", "update plots+filters", None))
        self.compPlotMarkSelectionsCheckBox.setText(_translate("VisDataDialog", "Mark selections\n"
"on Comp.plots", None))
        self.UpdatePlotPushButton.setText(_translate("VisDataDialog", "update plots only", None))
        self.ontheflyPushButton.setToolTip(_translate("VisDataDialog", "Perform on the first checked \"technique\" and \"type\"", None))
        self.ontheflyPushButton.setText(_translate("VisDataDialog", "perform on-the-fly", None))
        self.customxystylePushButton.setText(_translate("VisDataDialog", "configure\n"
"x-y style", None))
        self.SaveFigsPushButton.setText(_translate("VisDataDialog", "Save figs to ANA", None))
        self.platescatterLineEdit.setToolTip(_translate("VisDataDialog", "first character can be the markertype, e.g. \'s\' for square, or this can be omitted.\n"
"Rest of the string is the interger marker size.", None))
        self.platescatterLineEdit.setText(_translate("VisDataDialog", "s70", None))
        self.label_16.setText(_translate("VisDataDialog", "plate\n"
"scatter", None))
        self.ellabelsLineEdit.setToolTip(_translate("VisDataDialog", "Comment string to be included in EXP", None))
        ...
        self.platemapfilenameLineEdit.setToolTip(_translate("VisDataDialog", "Comment string to be included in EXP", None))
        self.SaveStdFigsPushButton.setText(_translate("VisDataDialog", "BatchSave StdPlots", None))
        self.LoadCsvPushButton.setText(_translate("VisDataDialog", "Load .csv", None))
        self.expanafilenameLineEdit.setToolTip(_translate("VisDataDialog", "Comment string to be included in EXP", None))
        ...
        self.BatchComboBox.setToolTip(_translate("VisDataDialog", "Apply all other filteres in this section to only this run", None))
        self.BatchPushButton.setToolTip(_translate("VisDataDialog", "Considering the files already in the EXP, keep the files that meet all criteria", None))
        self.BatchPushButton.setText(_translate("VisDataDialog", "Run Batch:", None))
        self.OpenInfoPushButton.setText(_translate("VisDataDialog", "Open via Search", None))
