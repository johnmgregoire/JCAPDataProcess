...
#        print 'skipping becuase already done ', fn
    ...
    append_udi_to_ana(l_anapath=[newanapath], l_anak_comps=['ana__9'], l_anak_patterns=['ana__5'], pattern_key='pattern_files', compkeys='AtFrac', q_key='q.nm_processed_resampled',intensity_key='intensity.counts_processed_resampled')
    append_udi_to_ana(l_anapath=[newanapath], l_anak_comps=['ana__9'], l_anak_patterns=['ana__6'], pattern_key='pattern_files', compkeys='AtFrac', q_key='q.nm_resampled',intensity_key='intensity.counts_resampled')
    append_udi_to_ana(l_anapath=[newanapath], l_anak_comps=['ana__9'], l_anak_patterns=['ana__7'], pattern_key='pattern_files', compkeys='AtFrac', q_key='q.nm_processed_resampled',intensity_key='intensity.counts_processed_resampled')
    append_udi_to_ana(l_anapath=[newanapath], l_anak_comps=['ana__9'], l_anak_patterns=['ana__8'], pattern_key='pattern_files', compkeys='AtFrac', q_key='q.nm_resampled',intensity_key='intensity.counts_resampled')
