...
def xy_file_dict_into_rcpdlist(dp, fn, rcpdlist):
    ...
    keysstr='two_theta.deg,intensity.counts' if 'original' in dp else 'two_theta.deg_processed,intensity.counts_processed'
    afd={'folderpath':dp, 'fn':fn, 'fn_gfrm':gfn, 'type':'pattern_files', 'fval':'xrds_csv_pattern_file;%s;1;%d;' %(keysstr, len(lines)-1)}
