...
class Std_Stack_Plot:
    ...
    def stackplot(
        self,
        ax,
        StackPlotDialogclass=None,
        stackplotkwargs={"alpha": 1.0, "lw": 0, "zorder": 1},
    ):
        stackplot(
            ax,
            StackPlotDialogclass.stackplotd["xarr"],
            StackPlotDialogclass.stackplotd["stackarr_keysbyxpts"],
            colors=StackPlotDialogclass.stackcolors,
            **stackplotkwargs
        )
