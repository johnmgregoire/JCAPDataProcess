...
plate_exp_str='5069: 20190221.094047,4074: 20190221.092325'
plate_exp_tups=[s.partition(': ')[::2] for s in plate_exp_str.split(',')]
#plate_exp_p_tups=[(pl,ex,buildexppath('L:\processes\experiment\eche\%s.done' %ex)) for pl,ex in plate_exp_tups]
...
exp_info_dlist=[dict({},plate_id=pl,exp_folder_path='L:\processes\experiment\eche\%s.done' %ex) for pl,ex in plate_exp_tups]
