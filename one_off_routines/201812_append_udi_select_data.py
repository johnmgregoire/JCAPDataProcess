...
append_udi_to_ana(l_anapath=[newanapath], l_anak_comps=['ana__6'], l_anak_patterns=['ana__2'], pattern_key='pattern_files', compkeys='AtFrac', q_key=q_key,intensity_key=intensity_key, pattern_fn_search_str='2nd_frame')
