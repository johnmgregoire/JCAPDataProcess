...
instp=r'L:\processes\analysis\ssrl\20190624.140000.run\ana__8_Bi-Cu-V307_inst_Q300.txt'
soltnp=r'L:\processes\analysis\ssrl\20190624.140000.run\ana__8_Bi-Cu-V307_sol_Q300.txt'

phaseinfop=r'L:\processes\analysis\ssrl\20190624.140000.run\ana__8_select_phases_info.csv'
icddzipp=r'L:\processes\analysis\ssrl\20190624.140000.run\ana__8_20190304_BiCuVO_FTO_assembled_icdd.zip'
miscfildesc='ssrl_misc_file;'
...
filedesc,filestr=createcsvfilstr_bare(dlist,savekeys[3:],intfomkeys=savekeys[:3],strfomkeys=[],return_file_desc=True)
ana__8csvfn=secondanak+'__'+'-'.join(savekeys[3:6])+'.csv'
