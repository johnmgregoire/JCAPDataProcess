...
class Ui_ExternalImportDialog(object):
    def setupUi(self, ExternalImportDialog):
        ...
        self.textBrowser_plate.setGeometry(QtCore.QRect(10, 420, 461, 361))
        ...
        self.label_15 = QtGui.QLabel(ExternalImportDialog)
        self.label_15.setGeometry(QtCore.QRect(290, 150, 265, 21))
        self.label_15.setObjectName(_fromUtf8("label_15"))
        self.AnaFileSelectTreeWidget = QtGui.QTreeWidget(ExternalImportDialog)
        self.AnaFileSelectTreeWidget.setGeometry(QtCore.QRect(290, 170, 271, 181))
        self.AnaFileSelectTreeWidget.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.AnaFileSelectTreeWidget.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.AnaFileSelectTreeWidget.setHeaderHidden(True)
        self.AnaFileSelectTreeWidget.setExpandsOnDoubleClick(False)
        self.AnaFileSelectTreeWidget.setObjectName(_fromUtf8("AnaFileSelectTreeWidget"))
        self.AnaFileSelectTreeWidget.headerItem().setText(0, _fromUtf8("1"))
        self.AnaFileSelectTreeWidget.header().setVisible(False)
        self.AnaFileSelectTreeWidget.header().setCascadingSectionResizes(False)
        self.AnaFileSelectTreeWidget.header().setStretchLastSection(True)
        self.AnaTreeWidget_2 = QtGui.QTreeWidget(ExternalImportDialog)
        self.AnaTreeWidget_2.setGeometry(QtCore.QRect(580, 290, 551, 231))
        self.AnaTreeWidget_2.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.AnaTreeWidget_2.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.AnaTreeWidget_2.setHeaderHidden(True)
        self.AnaTreeWidget_2.setExpandsOnDoubleClick(False)
        self.AnaTreeWidget_2.setObjectName(_fromUtf8("AnaTreeWidget_2"))
        self.AnaTreeWidget_2.headerItem().setText(0, _fromUtf8("1"))
        self.AnaTreeWidget_2.header().setVisible(False)
        self.AnaTreeWidget_2.header().setCascadingSectionResizes(False)
        self.AnaTreeWidget_2.header().setStretchLastSection(True)
        self.AnaTreeWidget_3 = QtGui.QTreeWidget(ExternalImportDialog)
        self.AnaTreeWidget_3.setGeometry(QtCore.QRect(580, 20, 551, 241))
        self.AnaTreeWidget_3.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.AnaTreeWidget_3.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.AnaTreeWidget_3.setHeaderHidden(True)
        self.AnaTreeWidget_3.setExpandsOnDoubleClick(False)
        self.AnaTreeWidget_3.setObjectName(_fromUtf8("AnaTreeWidget_3"))
        self.AnaTreeWidget_3.headerItem().setText(0, _fromUtf8("1"))
        self.AnaTreeWidget_3.header().setVisible(False)
        self.AnaTreeWidget_3.header().setCascadingSectionResizes(False)
        self.AnaTreeWidget_3.header().setStretchLastSection(True)
        ...
        self.label_17.setGeometry(QtCore.QRect(280, 40, 51, 21))
...
"can be performed", None))
        ...
        self.label_15.setText(_translate("ExternalImportDialog", "Choose ana files to include:", None))
