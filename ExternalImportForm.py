...
class Ui_ExternalImportDialog(object):
    def setupUi(self, ExternalImportDialog):
        ...
        self.AddToAnaPushButton = QtGui.QPushButton(ExternalImportDialog)
        self.AddToAnaPushButton.setGeometry(QtCore.QRect(170, 90, 91, 21))
        self.AddToAnaPushButton.setObjectName(_fromUtf8("AddToAnaPushButton"))
        self.critdistSpinBox = QtGui.QDoubleSpinBox(ExternalImportDialog)
        self.critdistSpinBox.setGeometry(QtCore.QRect(511, 90, 51, 22))
        self.critdistSpinBox.setProperty("value", 2.0)
        self.critdistSpinBox.setObjectName(_fromUtf8("critdistSpinBox"))
        self.label_19 = QtGui.QLabel(ExternalImportDialog)
...
"can be performed", None))
        ...
        self.AddToAnaPushButton.setToolTip(_translate("ExternalImportDialog", "Considering the files already in the EXP, keep the files that meet all criteria", None))
        self.AddToAnaPushButton.setText(_translate("ExternalImportDialog", "Addtl Analysis", None))
        self.label_19.setText(_translate("ExternalImportDialog", "crit. distance for\n"
